...
# NESPi Control Script V-1.0
# Author: beimklabautermann@mail.de
# Date: 04/28/2018

# Autostart: sudo systemctl enable nespi-recall.py
...
def pushButton(press)
    os.system('sudo shutdown -h now', 'sudo /etc/init.d/S31emulationstation stop && sudo /etc/init.d/S31emulationstation start')[press]
